export const MiniCalendar = (props) => {
    ...
    function dispatchEvent(nbr) {
        ...
        offset = offset - 1;
        let start_date =
            new Date(props.year, props.month - 1, nbr - offset).getTime() /
            1000;
        let end_date =
            new Date(
                props.year,
    ...
    const MiniJour = (props) => {
        ...
        return (
            <div
                className={selected ? "mini-jour mini-selected" : "mini-jour"}
                style={{ color: gris ? "#49505550" : "#111B22" }}>
                <p
                    className={
                        events[0]["blank"] === true &&
                        events[1]["blank"] === true
                ...
                <div className='mini-dot'>
                    ...
                    {events[0]["blank"] === false &&
                    events[1]["blank"] === false ? (
                        <div
                            className='mini-dot2'
                            style={{
    ...
    const Line = (props) => {
        ...
        var thisW = getWeek(
            new Date(props.year, props.month - 1, props.offset + 1)
        );
        ...
        return (
            <div className={classNom}>
                <MiniJour
                    month={props.month}
                    day={1 + props.offset}
                    premier={props.premier}
                    dernier={props.dernier}
                />
                <MiniJour
                    month={props.month}
                    day={2 + props.offset}
        ...
        <div className='mini-calendar'>
            <div className='mini-top'>
                ...
                <div className='mini-nav'>
                    <h2
                        className='mini-nav-prev'
                        onClick={() => props.prevMonth()}>
                        &#60;
                    </h2>
                    <h2
                        className='mini-nav-next'
